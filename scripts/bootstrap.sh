...
function _fmt ()      {
  ...
  echo -e "$(date +"%d.%m.%Y %H:%M:%S") ${color}$(printf "[%9s]" ${1})${color_reset}";
}
...
HELPERS_ROOT=$ROOT/scripts/_helpers

source $HELPERS_ROOT/git.sh
source $HELPERS_ROOT/symfony.sh
source $HELPERS_ROOT/gitlab.sh
source $HELPERS_ROOT/slack.sh