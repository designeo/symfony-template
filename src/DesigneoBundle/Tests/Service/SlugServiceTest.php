...
namespace DesigneoBundle\Tests\Service;

use DesigneoBundle\Service\SlugService;
...
class SlugServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $mock = $this->getMockBuilder('DesigneoBundle\Repository\Interfaces\iSlugglableRepository')
