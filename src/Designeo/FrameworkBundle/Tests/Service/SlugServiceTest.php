...
namespace Designeo\FrameworkBundle\Tests\Service;
 ...
 * @package Designeo\FrameworkBundle\Tests\Service
 */
class SlugServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $mock = $this->getMockBuilder('Designeo\FrameworkBundle\Repository\Interfaces\iSlugglableRepository')
